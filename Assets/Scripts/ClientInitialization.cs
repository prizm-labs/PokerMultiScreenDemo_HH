...
public class ClientInitialization : MonoBehaviour {
	...
	private string meteorURL = "ws://10.0.0.74:6969/websocket";	
	//private string meteorURL = "ws://localhost:6969/websocket";	

	string appID = "pokerTable";							//name of game
	...
	public void createMsgLog(string message, float timer = 0f) {
